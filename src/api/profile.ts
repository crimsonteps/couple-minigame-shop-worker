...
export async function handleProfileRequest(request: Request, context: AppContext): Promise<Response> {
  ...
  return getRoom(context).fetch(buildRoomRequest(`/internal/profile?user=${userId}`));
}
